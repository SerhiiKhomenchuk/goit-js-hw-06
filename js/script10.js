...
const inputQuantityOfElem = document.querySelector("#controls input");
// console.log(inputQuantityOfElem);

inputQuantityOfElem.addEventListener("input", onInput)
